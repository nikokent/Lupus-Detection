...
static NSString* model_file_name = @"stripped_graph"; //i updated the following items - this
...
static NSString* labels_file_name = @"retrained_labels"; //this
static NSString* labels_file_type = @"txt";
// These dimensions need to match those the model was trained with.
const int wanted_input_width = 299; // this
const int wanted_input_height = 299; //this
const int wanted_input_channels = 3;
const float input_mean = 128.0f; //this
const float input_std = 128.0f; //this
...
- (void)setupAVCapture {
  ...
  AVCaptureDevice *device = [self frontCamera]; //defaultDeviceWithMediaType:AVMediaTypeVideo
  ...
  [rootLayer setMasksToBounds:YES];
    [rootLayer setBackgroundColor:[[UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1.0] CGColor]];
...
- (IBAction)takePicture:(id)sender {
  if ([session isRunning]) {
    ...
    [sender setTitle:@"Capture" forState:UIControlStateNormal];
      buttonPressed.layer.cornerRadius = 20;
  }
}
...
- (void)addLabelLayerWithText:(NSString *)text
  ...
  [layer setString:text];
    ...
    //[CaptureButton setTitle:@"Capture Data" forState: normal];
    CaptureButton.layer.backgroundColor = [UIColor colorWithRed:0.87 green:0.23 blue:0.24 alpha:1.0].CGColor;
    CaptureButton.layer.borderWidth = 3.0;
    CaptureButton.layer.borderColor = [UIColor colorWithRed:0.87 green:0.23 blue:0.24 alpha:1.0].CGColor;
